...
const flowguardLogo = new URL("../assets/flowguard_logo.png", import.meta.url).href;
...
const sentinelauthLogo = new URL("../assets/sentinelauth_logo.png", import.meta.url).href;
const autoscaleCirmLogo = new URL("../assets/autoscale-logo.png", import.meta.url).href;
...
export const liveProjects = [
  ...
  {
    name: "StateStats",
    blurb: "State-level data explorer with interactive maps, comparisons, and public-data insights.",
    description:
  ...
  bio: [
    {
      parts: [
        ...
        { text: ", but the part of the work that pulls me in most is the " },
        { text: "interface", strong: true },
        { text: ". I enjoy turning complex ideas into experiences that feel " },
        { text: "clear, polished, and easy to use", strong: true },
        { text: "." },
      ],
    },
    {
      parts: [
        { text: "Right now, I’m putting a lot of energy into improving both my " },
        { text: "frontend engineering skills", strong: true },
        { text: " and my " },
        { text: "design sensitivity", strong: true },
        { text: ". I care about the details that make a product feel intentional — " },
        { text: "layout, hierarchy, motion, and the small decisions that shape how someone moves through a UI", strong: true },
        { text: "." },
      ],
    },
    {
      parts: [
        { text: "At the same time, I don’t want to think about the frontend in isolation. I still care about understanding the " },
        { text: "full application", strong: true },
        { text: " — " },
        { text: "data flow, APIs, auth, and the broader system decisions that make a product hold together", strong: true },
        { text: "." },
      ],
    },
  ],
